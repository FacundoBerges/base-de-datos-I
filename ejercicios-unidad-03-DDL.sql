...
INSERT INTO PROVEEDORES_PRODUCTOS (NUMERO, PNRO, CANTIDAD)
VALUES 
	(101, 001, 300),
	(101, 002, 200),
	(101, 003, 400),
...
(	SELECT *
	FROM proveedores
	WHERE UPPER(proveedores.localidad) = 'WILDE'
);
...
VALUES 
	('Raul', 'Gómez', 'Nazca 920', 'Capital Federal', 1),
...
VALUES 
	('Gómez, Raul', 'Nazca 920', 'Capital Federal'),
