...
CREATE TABLE EMPLEADOS (
	...
	CONSTRAINT EMPLEADOS_FK_OFICINAS_COD FOREIGN KEY (COD_OFIC) REFERENCES OFICINAS (COD_OFIC),
	CONSTRAINT CK_COD_EMP CHECK (COD_EMP >= 100 AND COD_EMP <= 1000),
	CONSTRAINT UK_TIPO_Y_NRO_DOC UNIQUE (TIPO_DOC, NUM_DOC),
	CONSTRAINT CK_CATEGORIA CHECK (UPPER(CATEGORIA) = 'SENIOR' OR UPPER(CATEGORIA) = 'SEMI SENIOR' OR UPPER(CATEGORIA) = 'JUNIOR')
);